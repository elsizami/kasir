					...
					<div class="col-sm-12">
						<div class="card">
							<div class="card-body">
								...
								<div align="right">
									<a href="tambah-produk.php" class="btn btn-primary mb-3">Tambah</a>
								</div>
									...
									<table class="table table-hover table-bordered">
										...
										<?php $no=1; while($row = mysqli_fetch_assoc($query)){ ?>
											<tr>
												...
												<td>
													<a href="tambah-produk.php?edit=<?php echo $row['id']; ?>">Edit</a> | <a onclick="return confirm('Apakah anda yakin akan menghapus data ini?')" href="tambah-produk.php?delete=<?php echo $row['id'] ?>">Hapus</a>
												</td>
											</tr>
										<?php } ?>
										</tbody>
